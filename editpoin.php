...
$poin = query("SELECT * FROM tab_poin WHERE id_poin = $id_poin")[0];
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="editpoin.php">Edit Poin</a>
                        </li>                                            
                        </ul>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="form-group">
                      <input class="form-control" type="text" name="id_poin" value= "<?= $poin["id_poin"]; ?>" readonly>
                    </div>
                    <div class="form-group">
                      <input class="form-control" type="text" name="poin" value= "<?= $poin["poin"]; ?>" >
                    </div>
