               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="poin.php">Tabel Poin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="pointambah.php">Tambah Poin</a>
                        </li>                       
                        </ul>
                    </div>
                    <div class="card-body">
                                             ...
                                             <thead class="thead-dark">
                                               ...
                                               <tbody>
                                                 ...
                                                 <tr>
                                                   ...
                                                   <td align="center">
                                                     <a href="editpoin.php?id_poin=<?php echo $row['id_poin'] ?>"> <i class="fa fa-edit fa-fw"></i>
                                                     </td>
                                                   <td align="center">
                                                     <a href="hapuspoin.php?id_poin=<?php echo $row['id_poin'] ?>"> <i class="fa fa-trash fa-fw"></i>
                                                     </td>
                                                 </tr>
                                                 <?php } ?>
                                             </tbody>
