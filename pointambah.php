               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="poin.php">Tabel Poin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="pointambah.php">Tambah Poin</a>
                        </li>                       
                        </ul>
                    </div>
                    <div class="card-body">
                      ...
                      <form class="form" action="pointambah.php" method="post">                       
                        ...
                        <div class="form-group">
                          <input class="form-control" type="text" name="nama_poin" placeholder="Nama Poin">
                        </div>
