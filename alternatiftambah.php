               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="alternatiftambah.php">Tambah Alternatif</a>
                        </li>                       
                        </ul>
                    </div>
                    <div class="card-body">
                      ...
                      <form class="form" action="alternatiftambah.php" method="post">                       
                        <div class="form-group">
                          <input class="form-control" type="text" name="nama_alternatif" placeholder="Nama alternatif">
                        </div>
